  ...
  private async initProjects() {
    this.projects = [
      ...
      },
      {
        ...
        progress: 100,
        chips: ["React", "Next.JS", ".NET 6", "ASP.NET Core", "C#", "TypeScript", "SignalR", "MySQL", "EntityFramework"],
      ...
      },
      {
        ...
        progress: 28,
        chips: ["Angular", ".NET 5", "ASP.NET Core", "TypeScript", "C#", "RabbitMQ", "Docker", "MySQL", "EntityFramework"],
        appURL: "",
      ...
      },
      {
        ...
        progress: 37,
        chips: ["Angular", ".NET 7", "ASP.NET Core", "C#", "TypeScript", "RabbitMQ", "SOA", "Microsservices", "Docker", "MySQL"],
        appURL: "",
        repoURL: "",
        repoEnabled: false,
        appEnabled: false,
